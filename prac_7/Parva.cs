  ...
  public class Parva {
    ...
    public static void Main (string[] args) {
      ...
      for (int i = 0; i < args.Length; i++) {
        ...
        else if (args[i].ToLower().Equals("-c")) Parser.listCode = true; // --------------------- Added -c input parameter
      ...
      if (inputName == null) {
        ...
        Console.WriteLine("-c produce a .out cod file");  // ------------------------- Added debugging for -c input parameter
      ...
      if (Parser.listCode == true) {  // --------------- Added if statement to listCode if input parameter or pragma included
