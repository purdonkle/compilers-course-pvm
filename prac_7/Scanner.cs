...
public class Scanner {
	...
	const int writeLine_Sym = 29;
	const int barbar_Sym = 30;
	const int andand_Sym = 31;
	const int plus_Sym = 32;
	...
	static Token NextToken() {
		...
		switch (state) {
			...
			case 19:
				...
				else if (ch == 'C') { buf.Append(ch); NextCh(); goto case 21; }
