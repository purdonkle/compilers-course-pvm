  ...
  // Utilities
    ...
    // Simple trace facility for run time debugging
      ...
      switch (cpu.ir) {
        ...
        case PVM.lda:
        case PVM.ldc:
        case PVM.stl:                                                                               // ADDED FOR TRACE
        case PVM.ldl:                                                                               // ADDED FOR TRACE
        case PVM.prns:
      ...
      do {
        ...
        switch (cpu.ir) {         // execute
          ...
          case PVM.ldc:           // push constant value
            ...
            break;
                    case PVM.ldc_0:                                                                 // LDC_0 ADDED
                        mem[--cpu.sp] = 0;
                        break;
                    case PVM.ldc_1:                                                                 // LDC_1 ADDED
                        mem[--cpu.sp] = 1;
                        break;
          case PVM.lda:           // push local address
            mem[--cpu.sp] = cpu.fp - 1 - mem[cpu.pc++];
            break;
                    case PVM.lda_0:                                                                 // LDA_0 ADDED
                        mem[--cpu.sp] = cpu.fp - 1;
                        break;
                    case PVM.lda_1:                                                                 // LDA_1 ADDED
                        mem[--cpu.sp] = cpu.fp - 2;
                        break;
                    case PVM.ldl:                                                                   // LDL ADDED
                        mem[--cpu.sp] = mem[cpu.fp - 1 - mem[cpu.pc++]];
                        break;
                    case PVM.ldl_0:                                                                 // LDL_0 ADDED
                        mem[--cpu.sp] = mem[cpu.fp - 1];
                        break;
                    case PVM.ldl_1:                                                                 // LDL_1 ADDED
...
*/
          ...
          case PVM.stk:           // stack dump (debugging)
            ...
            break;
                    case PVM.stl:                                                                   // STL ADDED
                        //tos = mem[cpu.sp++]; mem[mem[cpu.sp++]] = tos;
                        tos = mem[cpu.sp++]; mem[cpu.fp - 1 - mem[cpu.pc++]] = tos;
                        break;
                    case PVM.stl_0:                                                                 // STL_0 ADDED
                        //tos = mem[cpu.sp++]; mem[mem[cpu.sp++]] = tos;
                        tos = mem[cpu.sp++]; mem[cpu.fp - 1] = tos;
                        break;
                    case PVM.stl_1:                                                                 // STL_1 ADDED
                        //tos = mem[cpu.sp++]; mem[mem[cpu.sp++]] = tos;
                        tos = mem[cpu.sp++]; mem[cpu.fp - 2] = tos;
                        break;
